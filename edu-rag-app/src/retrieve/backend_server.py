...
def get_reference_docs():
    ...
    try:
        ...
        docs = search_only(
            question=prompt,
            emb_model=emb_model, emb_endpoint=emb_endpoint, max_tokens=emb_max_tokens,
            reranker_model=reranker_model, reranker_endpoint=reranker_endpoint,
            top_k=num_chunks_post_rrf, top_r=num_docs_reranker, use_reranker=use_reranker,
            vectorstore=vectorstore, search_mode="hybrid", language=language,
